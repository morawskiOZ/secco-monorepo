<script lang="ts">
  ...
  async function loadContent(contentId: number) {
    ...
    try {
      ...
      error = err instanceof Error ? err.message : 'Nie udało się załadować artykułu';
    } finally {
      loading = false;
    }
  }
...
<div class="page-header">
  <h1 class="page-title">Edytuj artykuł</h1>
  <a href="/tresci" class="btn btn-secondary">Powrót do listy</a>
</div>
